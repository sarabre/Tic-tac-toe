...
[CreateAssetMenu(fileName = "WinOpportunityStrategy", menuName = "Strategy/WinOpportunity")]

public class WinOpportunityStrategy : Strategy
{
    ...
    private bool IsWin(BoardModel board, Cell cell, Cell neighborCell, Cell empthyCell, CellMark winMark, out Cell move)
    {
        ...
        {
            return (board.GetCellMark(cell) == CellMark.Blank
                && board.GetCellMark(neighborCell) == winMark
